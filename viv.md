...
![***Figure 1** - Single degree of freedom model: the model intentionally neglects in-line motion to isolate cross-flow dynamics.*](attachment:7b580279-90f2-40a4-b27c-beadff0fcd59:viv_model.png)
...
The corresponding Reynolds numbers are evaluated for each case according to the standard definition:
...
![***Figure 2** - Geometry of the fluid domain.*](attachment:87c168a4-9424-4b37-bc79-b88194b1a1c3:fluid_domain.png)
...
![***Figure 3** - Boundary layer mesh (image used courtesy of ANSYS, Inc.).*](attachment:de209d26-0900-4c91-befc-ef80553d239d:mesh2.png)

***Figure 3** - Boundary layer mesh (image used courtesy of ANSYS, Inc.).*

![***Figure 4** - Wake region mesh (image used courtesy of ANSYS, Inc.).*](attachment:fb1cc68f-fbf9-43b4-b35f-4f801d7b1569:mesh1.png)
...
The boundary layer thickness is estimated using the empirical relation for turbulent flow over a flat plate:
...
![***Figure 5** - Time evolution of the wall unit $y^+$ showing values close to 1, indicating adequate near-wall resolution.*](attachment:2e81f0ad-52a7-4577-9c5e-adbe56f5585e:image39.png)
...
![***Figure 6** - Power spectral density of aerodynamic coefficients and transverse displacement.*](attachment:3a6ead3e-466e-4fb4-8877-50643261b668:psd.png)
...
![***Figure 7** - Variation of the lift coefficient amplitude $|C_l|$, mean drag coefficient $\overline{C_d}$ and transverse displacement amplitude $|y|$ with Reynolds number.*](attachment:e5dd5c65-2d55-4155-a1c0-f78a5a33afaf:tab.png)
